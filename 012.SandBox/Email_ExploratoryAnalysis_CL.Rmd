...
ConvertTotal <- melt(Summary_Membership_stat, id=1, measure=c("Total_conversions_Ro", "Total_conversions_Rc", "Total_conversions_Fc","Total_conversions_Fo"))
...
ggplot(ConvertID, aes(x=RFM_Score, y=value, colour=variable, shape=variable)) + 
  ...
  scale_size_area() + 
  scale_colour_brewer(palette = "Set1") +
  ggtitle("Conversions per Membership by RF") +
...
ggplot(SentTotal, aes(x=RFM_Score, y=value, colour=variable, shape=variable)) + 
  ...
  scale_size_area() + 
  scale_colour_brewer(palette = "Set1") +
  ggtitle("Total Sents by RF") +
  ylab("Total Sents") + theme(
  panel.background = element_rect(fill="light grey")
)
...
ggplot(SentID, aes(x=RFM_Score, y=value, colour=variable, shape=variable)) + 
  ...
  scale_size_area() + 
  scale_colour_brewer(palette = "Set1") +
  ggtitle("Sent per membership by RF") +
  ylab("Sent per membership")
```
...
ggplot(ConverSent, aes(x=RFM_Score, y=value, colour=variable, shape=variable)) + 
  ...
  scale_size_area() + 
  scale_colour_brewer(palette = "Set1") +
  ggtitle("Conversion per Sent by RF") +
  ylab("Conversion per Sent") + theme(
  panel.background = element_rect(fill="light grey")
)
